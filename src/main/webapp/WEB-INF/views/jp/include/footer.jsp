        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="${root}/#about">HAOUSE 紹介</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="${root}/#team">チームメンバ</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="${root}/searchDong">同別実取引価格情報</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="${root}/list">お知らせ事項</a></li>
            </ul>
          </div>
          ...
          <h4>&nbsp;</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">同別実取引価格情報</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">アパートの実取引価格情報</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">周辺地域の月平均の実取引価格の視覚化</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">周辺商圏照会</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">会員コミュニティ</a></li>
            </ul>
          </div>

          <div class="col-lg-4 col-md-6 footer-newsletter">
            <h4>Newsletter 定期購読</h4>
            <p>毎月新しいお知らせをEメールで送ります。<br> お望みでしたらEメールを送って購読してください。 ☺</p>
