    ...
    <div class="container d-flex">
      <div class="contact-info mr-auto" style="margin-top:10px;">
        <ul>
          ...
          <li><i class="icofont-clock-time icofont-flip-horizontal"></i> Mon-Fri 09:00 - 18:00</li>
      ...
      <div class="cta">
        ...
        <c:if test="${loginuser eq null }">
			<a class="scrollto" id="login" href="${root}/us/goLogin" style="margin-top:10px; margin-bottom:10px;">Log In</a>
		</c:if>
		<c:if test="${loginuser ne null }">
			Welcome. ${loginuser.uName}&nbsp;&nbsp;
			<a class="scrollto" id="logout" href="${root}/us/logout"  style="margin-top:10px; margin-bottom:10px;">Logout</a>
		</c:if>
      </div>
    </div>
  </section>
  ...
  <header id="header">
    <div class="container d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li><a href="${root}/#about">HAOUSE</a></li>
          <li><a href="${root}/#team">Team</a></li>
          <li class="drop-down"><a href="${root}/#services">Service</a>
            <ul>
              <li><a href="${root}/${nation}/searchDong">Price comparison</a></li>
              <li><a href="${root}/${nation}/searchApt?AptName=전체">Price information by apartment</a></li>
	          <c:if test="${loginuser ne null}">
				 <li><a href="${root}/${nation}/chart?id=${loginuser.id}">Search Information</a></li>
	    	     <li><a href="${root}/${nation}/getFavorite?user_id=${loginuser.id}">Areas of Interest</a></li>
	          </c:if>
            </ul>
          </li><%-- href="${root}/#contact" --%>
          <c:if test="${loginuser ne null}">
          	<li><a href="${root}/${nation}/board">Q&A</a></li>
          </c:if>
          <li><a href="${root}/${nation}/list">Notice</a></li>
		<c:if test="${loginuser ne null}"><li><a class="scrollto" id="profile" href="${root}/us/userinfo?id=${loginuser.id}">MemberInfo</a></li></c:if>
        </ul>
      </nav>
      <!-- .nav-menu -->
