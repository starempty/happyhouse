...
<body>
	<div class="login-reg-panel" data-aos="fade-in">
		...
		<div class="register-info-box">
			...
			<p>Let's Join Us</p>
			<label id="label-login" for="log-login-show" ><a href="${root}/us/signUp" style="color:white">JoinMember</a></label>
			<input type="radio" name="active-log-panel" id="log-login-show">
		</div>
							
		<div class="white-panel">
			<form action="${root}/us/login" method="post">
				<div class="login-show show-log-panel">
					<h2>LogIn</h2>
					<input type="text" id="id" name="id" placeholder="id">
					<input type="password" id="pass" name="pass" placeholder="password">
					<input type="submit" value="login">
					<a href="${root}/us/findPass">Forgot Password?</a>
				</div>
			</form>
